...
class OpenLibraryMetadataProviderTests {

    @Inject
    lateinit var metadataProvider: OpenLibraryMetadataProvider

    @Inject
    var dataService: OpenLibraryDataService? = null
    ...
    @MockBean(OpenLibraryDataService::class)
    fun dataService(): OpenLibraryDataService {
        return mock(OpenLibraryDataService::class.java)
    }
